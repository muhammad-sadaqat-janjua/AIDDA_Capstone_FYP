...
import static com.duskdevotee.aidda.VideoFaceDetectionActivity.context;
...
//        canvas.drawText("id: " + mFaceId, x + ID_X_OFFSET, y + ID_Y_OFFSET, mIdPaint);
        canvas.drawText("Left Eye: " + face.getIsLeftEyeOpenProbability(), 50, canvas.getHeight()/4, mIdPaint);
        canvas.drawText("Right Eye: " + face.getIsRightEyeOpenProbability(), 450, canvas.getHeight()/4, mIdPaint);
       //turnedoff
